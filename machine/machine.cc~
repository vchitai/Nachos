...
//Ham sao chep noi dung chuoi tu Kernel Space sang User Space
int Machine::System2User(int virtAddr,int len,char* buffer)
{
	//Kiem tra do chinh xac cua chuoi
	if (len < 0) return -1;
	if (len == 0)return len;
	//Bat dau doc tung ky tu va ghi vao thanh ghi trong User Space
	int i = 0;
	int oneChar = 0 ;
	do{
...
//Ham sao chep noi dung chuoi tu User Space sang Kernel Space
char* Machine::User2System(int virtAddr,int limit)
{
	...
	//Bat dau doc tung ky tu tu thanh ghi trong User Space va luu vao Kernel Space
	for (i = 0 ; i < limit ;i++)
	{
